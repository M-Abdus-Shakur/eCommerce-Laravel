        ...
        <div class="card mb-4">
            <div class="card-body">
                <form wire:submit.prevent="addProduct">
                    ...
                    <div class="mb-4">
                        <label for="product_category_id" class="form-label">Select Category</label>
                        <select id="product_category_id" class="form-select" wire:model="product_category_id">
                            <option selected>Select Category</option>
                            @foreach ($categories as $category)
                                 <option value="{{ $category->id }}" @if ($loop->first) selected @endif>{{ $category->category_name }}</option>
                            @endforeach
                        </select>
                    </div>

                    <div class="mb-4">
                        <label for="product_subcategory_id" class="form-label">Select Subcategory</label>
                        <select id="product_subcategory_id" class="form-select" wire:model="product_subcategory_id">
