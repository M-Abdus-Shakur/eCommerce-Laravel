                        ...
                        <div class="row g-0">
                            <div class="col-12 col-lg-5">
                                <div class="image-zoom-section">
                                    <div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
                                        <div class="item">
                                            <img src="{{Storage::url($product->product_image)}}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                                        <button class="owl-thumb-item">
                                            <img src="{{Storage::url($product->product_image)}}" class="" alt="">
                                        </button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-7">
                                <div class="product-info-section p-3">
                                    ...
                                    <dl class="row mt-3">	<dt class="col-sm-3">Product Stock</dt>
                                        <dd class="col-sm-9">{{$product->product_quantity}}</dd>	<dt class="col-sm-3">Delivery</dt>
